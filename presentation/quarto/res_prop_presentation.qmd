...
Efforts to improve metadata

Generative AI in academic libraries

Metadata may be available when the full text is paywalled
...
-   Metadata source: compares two sources for any transformations

-   evidence for metadata directly as a document source in RAG
...
![](images/sankey.png){fig-align="center" width="80%"}
Transformation of one license type to another with example of information loss. 
