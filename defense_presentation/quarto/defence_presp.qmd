...
- missing and info loss biggest categories, 
- identified datatype, semantinc, and multilingual text as problems

### R2: OpenAlex does not eliminate these problems
- improvements in langauge assignment
- improvemnts to address missing information
- reduction in datatype noise, but increase in multilingual text

### RQ3: most metrics unaffected
- multilingual text provides a beneficial effect on retrieval
- scientometric perspective, does this give publishers an advantage?
- datatype noise had no effect, but caveats on mmy method
...
### Methodological
- Analysis of textual characteristics
- Merged LIS & NLP perspectives
...
3. multiple language values; language attributes, 3 letter ISO code, imaging tuple of multiple language codes
:::
...
- What are the effects of hidden Unicode?
