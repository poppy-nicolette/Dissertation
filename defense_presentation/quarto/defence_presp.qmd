...
### Theoretical
- update to IS&R for use with RAG terminology and processes

### Methodological
- classification scheme merging LIS & NLP perspectives for metadata quality

### Practical
- data on content as it affects NLP processes
- documenting differences between Crossref and OpenAlex
- data supporting sensitivity of RAG to inputs
