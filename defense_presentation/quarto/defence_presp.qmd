...
- background
- physical tool making to digital tool making
- lack of science and evidence in design
:::
...
::: notes
- Title and abstract, why are these significant?
:::
...
::: notes
prior research
- Coverage & Availability (Alonso-Álvarez & van Eck 2024)
- Coverage, Accuracy, Completeness (Céspedes et al., 2024; Visser et al., 2021)
- Coverage (Culbert et al., 2024)
- Completeness (Delgado-Quirós & Ortega 2024)
- Availability (Eck & Waltman 2022)
- Completeness, Consistency, Conformity, Access (Király et al. 2019)
- Availability & Completeness (Kramer & de Jonge 2022)
- Accuracy (Mongeon et al., 2025)
- Accuracy (Sainte-Marie et al., 2025)
- Coverage & Accuracy (Schares 2024)
- Accuracy, Consistency, Completeness (Shi et al., 2023)
- Coverage (Simard et al., 2024)
- Accessibility & Coverage (Zhang et al., 2024)

- Yasser et al., (2011) ‘poorly created metadata records result in poor retrieval and limit accessibility to collections’. They classified problems as “Incorrect Values, Incorrect Elements, Missing Information, Information Loss, and Inconsistent Value Representation ” (Yasser, 2011, p. 51). also Bruce and Hillman; Delgado-Quirós & Ortega
...
Provide some code as example executable codeblock??
