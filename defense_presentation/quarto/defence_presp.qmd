...
-   Information loss and missing info most significant problems
-   Datatype, semantic, and multilingual are not uncommon
-   Ingest processes at OpenAlex introduce multilingual text
-   Most metrics are not significantly affected
-   Multilingual text causes both beneficial and harmful effects
