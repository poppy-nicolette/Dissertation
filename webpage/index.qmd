...
In the table below are errors and noise categories applied to problems found in the title subset analysis across journal articles, book chapters, and conference proceedings. <br>
...
|Total	|223	|100.0%	|2.2%|
: Title mismatches labelled by error and noise classification scheme. {.light .hover}
...
|Total  |688    |100%   |   6.9%|
: Differences in abstracts between Crossref and OpenAlex. {.light .hover}
