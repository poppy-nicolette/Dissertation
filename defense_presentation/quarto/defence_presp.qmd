...
![Example of keyword search interface](images/novanet.png){fig-align="center" width="100%"}

## What is Bibliographic Metadata?

::: notes
the data about scholarly resources, books, articles, datasets, used for resource location, retrieval, identification, commpliance, preservation
:::
...
Examples of metadata from each

::::: columns
::: {.column width="50%"}
![metadata from Crossref](){fig-align="center" width="50%"}
:::

::: {.column width="50%"}
![metadata from OpenAlex](){fig-align="center" width="100%"}
:::
:::::
...
::: notes
Improve this with types of metadata quality: completeness, etc. (Kumar?)
